...
--create endpoint:
CREATE ENDPOINT [Hadr_endpoint] AUTHORIZATION [Domain\AGsrv] AS TCP (LISTENER_PORT = 5022)
       FOR DATA_MIRRORING (ROLE = ALL, ENCRYPTION = REQUIRED ALGORITHM AES)

GRANT CONNECT ON ENDPOINT::[Hadr_endpoint] TO [Domain\gmSQL$]  
GRANT ALTER ANY AVAILABILITY GROUP TO [Domain\gmSQL$];
GRANT CONNECT SQL TO [Domain\gmSQL$];
GRANT VIEW SERVER STATE TO [Domain\gmSQL$];
GO
ALTER AUTHORIZATION ON ENDPOINT::Hadr_endpoint TO [Domain\gmSQL$];
GO
